<template>
  <div class="flex lg:max-w-4xl max-w-3xl lg:flex-grow">
    <div class="lg:w-1/2 marlene-bg-glass rounded-l-lg invisible lg:visible w-0">
      <div>
        <img src="../../../public/register.png" alt="" class="-mt-20 w-10/12 ml-8" />
      </div>
    </div>
    <div
      ...
      <form class="space-y-8">
        <div class="space-y-6">
          <div class="flex space-x-2 block">
            <input
              class="border border-gray focus:border-primary rounded-lg appearance-none p-1 pl-2 h-12 focus:outline-none focus:ring-1 focus:ring-primary"
              placeholder="用户名"
              type="text"
            />
            <input
